...
import { postText2OwnerChannel, postText2LogChannel } from "./modules/slack";
...
const updateStatus = async () => {
  await postText2LogChannel(":broom: 割り当て状態のリセットをチェックします。");
  ...
  if (updateNeeded) {
    // 全員の割り当て状態を未割り当てに更新
    await postText2OwnerChannel(":broom:全員の割り当て状態をリセット");
